...
urlpatterns = [
    ...
    path('time-entry/edit/<int:entry_id>/', edit_time_entry, name='edit_time_entry'),
    path('time-entry/delete/<int:entry_id>/', delete_time_entry, name='delete_time_entry'),
    ...
    path('switch-organization/<int:organization_id>/', switch_organization, name='switch_organization'),
